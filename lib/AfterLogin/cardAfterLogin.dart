...
class CardAfterLogin extends StatefulWidget {
 ...
 // final String status;
  //this.status
  CardAfterLogin(this.drugName,  this.drugForm,this.price, this.x, this.y);
  @override
  _CardAfterLoginState createState() => _CardAfterLoginState(this.drugName,  this.drugForm, this.x, this.y  );
}

class _CardAfterLoginState extends State<CardAfterLogin> {
  final String drugName;
  final String drugForm;
  final int x;
  final int y;
  ...
  _CardAfterLoginState(@required this.drugName, @required this.drugForm,@required this.x,@required this.y );
